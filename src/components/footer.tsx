  ...
  return (
    <footer className="bg-primary text-white/70 mt-auto">
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
          ...
          <div className="space-y-3">
            <Link href="/" className="flex items-center gap-3">
              <img src="/logo.png" alt="Kasheer360" className="h-16 sm:h-20 lg:h-24 w-auto object-contain brightness-0 invert" />
            </Link>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs font-medium text-accent uppercase tracking-wider mb-4">Explore</h4>
            <nav className="space-y-2.5">
              <Link href="/" className="block text-sm text-white/60 hover:text-white transition-colors">
                Browse Operators
              </Link>
              <Link href="/search" className="block text-sm text-white/60 hover:text-white transition-colors">
                Search
              </Link>
              <Link href="/favorites" className="block text-sm text-white/60 hover:text-white transition-colors">
                Favorites
              </Link>
              <Link href="/join" className="block text-sm text-white/60 hover:text-white transition-colors">
          ...
          {/* Connect */}
          <div>
            <h4 className="text-xs font-medium text-accent uppercase tracking-wider mb-4">Connect</h4>
            <div className="space-y-3">
              <a
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 mt-10 pt-6 border-t border-white/10">
