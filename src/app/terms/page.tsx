  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-lg mx-auto px-4 py-6 text-sm text-gray-700 space-y-4">
        ...
        <p>Kasheer360 is a discovery platform. All transactions, bookings, and agreements are between you and the operator. Kasheer360 does not facilitate payments or bookings in its current version.</p>
        <h2 className="text-base font-semibold">For Operators</h2>
        <p>By submitting a profile, you confirm that all information provided is accurate. Kasheer360 reserves the right to reject, suspend, or remove listings that violate our guidelines.</p>
        <h2 className="text-base font-semibold">Limitation of Liability</h2>
        <p>Kasheer360 is not liable for any disputes, damages, or losses arising from interactions between tourists and operators.</p>
